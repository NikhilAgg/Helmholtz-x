...
with XDMFFile(MPI.COMM_WORLD, "Results/p_1_adj.xdmf", "w", encoding=XDMFFile.Encoding.HDF5) as xdmf:
    xdmf.write_mesh(mesh)
    xdmf.write_function(p_1_adj)
with XDMFFile(MPI.COMM_WORLD, "Results/p_2_adj.xdmf", "w", encoding=XDMFFile.Encoding.HDF5) as xdmf:
    xdmf.write_mesh(mesh)
    xdmf.write_function(p_2_adj)
