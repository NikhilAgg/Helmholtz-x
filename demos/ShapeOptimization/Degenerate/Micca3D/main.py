...
p_adj_norm_1 = normalize_adjoint(omega_1, p_dir1, p_adj1, matrices, D)
p_adj_norm_2 = normalize_adjoint(omega_2, p_dir2, p_adj2, matrices, D)
...
p_dir1.name = "P_1_Direct"
p_dir2.name = "P_2_Direct"
p_adj1.name = "P_1_Adjoint"
p_adj2.name = "P_2_Adjoint"
...
micca = MiccaGeom(mesh,subdomains,facet_tags)
