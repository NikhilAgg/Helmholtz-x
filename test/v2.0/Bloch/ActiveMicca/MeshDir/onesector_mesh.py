...
# import micca_flame_physical_groups as physical
...
def add_physical_entities():
    ...
    # my_func(my_dict['pl_outer'], 2)
    # my_func(my_dict['pl_inner'], 3)
    # my_func(my_dict['pl_front'], 4)
    # my_func(my_dict['b_lateral'], 5)
    # my_func(my_dict['b_front'], 6)
    # my_func(my_dict['pp_lateral'], 7)
    # my_func(my_dict['cc_front'], 8)
    # my_func(my_dict['cc_outer'], 9)
    # my_func(my_dict['cc_inner'], 10)
    # my_func(my_dict['cc_outlet'], 11)

    gmsh.model.addPhysicalGroup(2, [1,56], tag=1)
    gmsh.model.addPhysicalGroup(2, [3,68], tag=2)
    gmsh.model.addPhysicalGroup(2, [5,78], tag=3)
    gmsh.model.addPhysicalGroup(2, [6,83], tag=4)
    gmsh.model.addPhysicalGroup(2, [9,10,102,107], tag=5)
    gmsh.model.addPhysicalGroup(2, [11,112], tag=6)
    gmsh.model.addPhysicalGroup(2, [14,15,128,133], tag=7)
    gmsh.model.addPhysicalGroup(2, [22,170], tag=8)
    gmsh.model.addPhysicalGroup(2, [24,187], tag=9)
    gmsh.model.addPhysicalGroup(2, [26,197], tag=10)
    gmsh.model.addPhysicalGroup(2, [27,202], tag=11)
    ...
    gmsh.model.addPhysicalGroup(3, [1,2,3,5,203,243,276,333], tag=99)
    gmsh.model.geo.synchronize()
